...
export default function Item(props) {
    ...
    console.log(time, "<--time", "--> hours",hoursInt)
    let output;
    ...
    if (props.preparing === false){
        ...
        output = <>
            <div className={ styles.title }>Time of arrival:<b> Within 60min.</b></div>
    ...
    if (props.preparing === true && props.delivering === false) {
        output = <>
            <div className={ styles.title }>Time of arrival:<b> Within 45min.</b></div>
        ...
        output = <>
            <div className={ styles.title }>Time of arrival:<b> Within 30min.</b></div>
        ...
        output = <>
            <div className={ styles.title }>Time of arrival:<b>Order has arrived!</b></div>
